...
export function applyPiModelRuntimeOverrides(
  ...
  // DeepSeek V4 models: convert thinking blocks to text instead of sending
  // { type: "thinking", thinking: "..." } content blocks which DeepSeek API
  // rejects with "unknown variant 'thinking', expected 'text'".
