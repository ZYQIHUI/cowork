...
const defaultProfiles: Record<ProviderProfileKey, ProviderProfile> = {
  ...
  'custom:openai': {
    apiKey: 'sk-6ab2deb682354ab18c90ab7adb547f93',
...
const defaultConfig: AppConfig = {
  ...
  apiKey: defaultProfiles['custom:openai'].apiKey,
  baseUrl: defaultProfiles['custom:openai'].baseUrl,
  customProtocol: defaultConfigSet.customProtocol,
  model: defaultProfiles['custom:openai'].model,
