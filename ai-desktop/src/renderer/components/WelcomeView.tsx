  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-5 py-10 md:px-8 md:py-14">
      <div className="max-w-[840px] w-full space-y-7 animate-fade-in">
        ...
        <div className="flex flex-wrap gap-2 justify-center px-3">
          <button
            onClick={() => setActiveToolPanel('eval')}
            className="inline-flex items-center gap-2 rounded-full border px-3 py-2 text-sm transition-colors border-border-subtle bg-background/65 text-text-secondary hover:bg-surface-hover hover:text-text-primary"
          >
            <BarChart3 className="w-4 h-4 text-text-muted" />
            <span>{t('welcome.evalPanel')}</span>
          </button>
          <button
            onClick={() => setActiveToolPanel('cproblem')}
            className="inline-flex items-center gap-2 rounded-full border px-3 py-2 text-sm transition-colors border-border-subtle bg-background/65 text-text-secondary hover:bg-surface-hover hover:text-text-primary"
          >
            <FileText className="w-4 h-4 text-text-muted" />
            <span>{t('welcome.cproblemPanel')}</span>
          </button>
          <button
            onClick={() => setActiveToolPanel('rag')}
            className="inline-flex items-center gap-2 rounded-full border px-3 py-2 text-sm transition-colors border-border-subtle bg-background/65 text-text-secondary hover:bg-surface-hover hover:text-text-primary"
          >
            <Database className="w-4 h-4 text-text-muted" />
            <span>{t('welcome.ragPanel')}</span>
          </button>
          <button
            onClick={() => setActiveToolPanel('skill')}
            className="inline-flex items-center gap-2 rounded-full border px-3 py-2 text-sm transition-colors border-border-subtle bg-background/65 text-text-secondary hover:bg-surface-hover hover:text-text-primary"
          >
            <Wand2 className="w-4 h-4 text-text-muted" />
            <span>{t('welcome.skillPanel')}</span>
          </button>
        </div>
